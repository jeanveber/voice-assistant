...
def GladosMain(data):#main process
    ...
    if "how are you" in data or "how are you?" in data:
        ...
        news_webpage_view_choice2 = input("me: ")

    elif 'compute' in data or 'ask question' in data or 'do you know' in data:
        speak("Please, repeat your question.")
        import wolframalpha 
